...
class Vehicle(models.Model):
    ...
    motorisation = models.CharField("motorisation", max_length=20, choices=Motorisation.choices)
    ...
    mode = models.CharField("mode", max_length=20, choices=Mode.choices, default=Mode.ACHAT)
