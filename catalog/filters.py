...
class VehicleFilter(django_filters.FilterSet):
    marque = django_filters.CharFilter(field_name="marque", lookup_expr="icontains", label="Marque")
    modele = django_filters.CharFilter(field_name="modele", lookup_expr="icontains", label="Modèle")
